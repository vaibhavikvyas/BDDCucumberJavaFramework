...
#    And I Select Date Of Birth Day "03" Month "July" Year "1986"
    ...
    Examples:
      ...
      | vaibhavi21@yahoo.com | password21 | password21      |
      | vaibhavi22@yahoo.com | password22 | password22      |
      | vaibhavi23@yahoo.com | password23 | password23      |
      | vaibhavi24@yahoo.com | password24 | password24      |
      | vaibhavi25@yahoo.com | password25 | password25      |
  ...
  Scenario Outline: LogIn with valid credentials
    ...
    Examples:
      | email              | password   |
      | vaibhavi21@yahoo.com | password21 |
